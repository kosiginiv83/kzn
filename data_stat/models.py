...
class Quiz(models.Model):
    questions = models.ManyToManyField(VoteAnswer, verbose_name='Вопросы', related_name='quiz')
    preamble = models.TextField(blank=True)
...
class QuizQuestion(models.Model):
    quiz = models.ForeignKey(Quiz, on_delete=models.CASCADE, verbose_name='Вопросы', related_name='qquestions')
